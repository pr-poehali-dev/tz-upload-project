...
export const mockCertTypes = [
  { id: 1, name: 'ОТ', description: 'Охрана труда' },
  { id: 2, name: 'ЭБ', description: 'Электробезопасность' },
  { id: 3, name: 'ПБ', description: 'Пожарная безопасность' },
  { id: 4, name: 'Стропальщик', description: 'Стропальщик' },
  { id: 5, name: 'ПТМ', description: 'Подъемно-транспортные механизмы' },
];

export const mockCertAreas = [
  { id: 1, certTypeId: 1, name: 'А', description: 'Руководители' },
  { id: 2, certTypeId: 1, name: 'Б', description: 'Специалисты' },
  { id: 3, certTypeId: 1, name: 'ПП', description: 'Первая помощь' },
  { id: 4, certTypeId: 2, name: 'тепло', description: 'Теплоэнергетика' },
  { id: 5, certTypeId: 2, name: 'Электро 4 гр', description: 'Электробезопасность 4 группа' },
  { id: 6, certTypeId: 3, name: 'Переподготовка', description: 'Переподготовка ПБ' },
];
...
export const mockEmployees = [
  ...
  {
    id: 3,
    fullName: 'Ивлев Семен Владимирович',
    company: 'ООО Ромашка',
    positions: [4],
  },
];
